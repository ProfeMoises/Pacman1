# 🟡 Pac-Man – Juego Clásico en Canvas

¡Revive la experiencia del arcade original con este Pac-Man programado en HTML, CSS y JavaScript usando Canvas! Un homenaje al clásico de 1980 con laberinto, fantasmas, power pellets y todo el sabor retro.

---

## 🎮 Cómo jugar

El objetivo es simple: **come todos los puntos del laberinto** evitando a los fantasmas. ¡Pero cuidado! Si te tocan, pierdes una vida. Usa los **power pellets** para volverte invencible temporalmente y poder comer a los fantasmas.
...
- ✅ Inteligencia artificial básica de los fantasmas (cambio de dirección en intersecciones, evitar retroceso).
- ✅ Sistema de niveles progresivos (aumenta velocidad de fantasmas).
...
- ✅ Diseño responsivo y compatible con pantallas táctiles (aunque los controles son por teclado).
...
El juego está íntegramente construido con tecnologías web estándar:
- **HTML5 Canvas** para todo el renderizado.
- **JavaScript** puro para la lógica de juego, sin dependencias externas.
- **CSS** para la interfaz y los efectos visuales extra.
...
2. Ábrelo en cualquier navegador moderno (Chrome, Firefox, Edge, etc.).
3. ¡A jugar!

Puedes modificar fácilmente parámetros como la velocidad de Pac-Man o la duración del efecto Power Pellet editando las variables al inicio del bloque `<script>`.

---

## 🏆 ¿Crees que puedes lograr la puntuación perfecta?

¡Demuéstralo! Controla a Pac-Man, devora todos los pellets y conviértete en una leyenda del laberinto.
